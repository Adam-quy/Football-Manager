...
public class ResultsController implements Initializable{
    @FXML
    private ScrollPane Match_result;
//    @Autowired
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Match_result.setContent(mainContent);
        Match_result.setFitToWidth(true);
    }
...
//        homeGroup.setStyle("-fx-background-color: yellow;");
        ...
        resultLabel.setStyle("-fx-font-weight: bold;-fx-background-color: #3a0ca3; -fx-background-radius: 5px; -fx-text-fill: #fff;");
        resultLabel.setPrefWidth(40);
        resultLabel.setMaxWidth(80);
...
//        info.setStyle("-fx-background-color: #4cc9f0");
        info.getChildren().addAll(homeGroup, resultLabel, awayGroup);
...
//        quickViewBox.setStyle("-fx-background-color: green;");
    ...
    private void openMatchResult(Match match) {
        try {
            ...
            controller.loadMatchResult(match);
